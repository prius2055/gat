          ...
          <div className="contact-details">
            ...
            <div className="contact-item">
              ...
              <div>
                ...
                <p className="contact-item-text">
                  +234 (0) 803 941 1592 (Nigeria)
                </p>
                <p className="contact-item-text">
                  +234 (0) 802 315 5118 (Nigeria)
                </p>
            ...
            <div className="contact-item">
              ...
              <div>
                ...
                <p className="contact-item-text">Saturday: 9:00 AM - 2:00 PM</p>
              </div>
            </div>
          </div>
            ...
            <div className="contact-address">
              ...
              <div>
                <p className="contact-item-text">
                  Lagos Office
                  <br />
                  27 Yaya Abatan Road Ogba-Ikeja, Lagos
                  <br />
                  Lagos, Nigeria
                </p>
              </div>
              <div>
                <p className="contact-item-text">
                  Benin City Office
                  <br />
                  5 Eguadase Street Off Akpakpava Road
                  <br />
